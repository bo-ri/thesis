...
\snum{38118002}
\jname{北堀 達也}
\thesistitle{単語ベクトルを用いた関連大学推薦システム} %タイトルを記入
% \title{Related Universities Reccomendation System with Word Vector}
% \thesissubtitle{Related Universities Reccomendation System with Word Vector} %サブタイトルを記入 ない場合はコメントアウト
